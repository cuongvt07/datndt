<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <a href="<?php echo e(route('admin.orders.create')); ?>" class="btn btn-primary">Tạo mới đơn hàng</a>
        ...
        <table class="table table-hover mt-3">
            ...
            <tbody>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($order->status == 'pending' || $order->status == 'confirmed' || $order->status == 'delivering'): ?>
                        <tr>
                            ...
                            <?php if($order->user_id): ?>
                                ...
                                <strong style="font-size: 12px"><?php echo e(number_format($order->total_after_discount, 0, ',', '.')); ?> ₫</strong>
                            <?php else: ?>
                          
                                <strong style="font-size: 12px"><?php echo e(number_format($order->total_price, 0, ',', '.')); ?> ₫</strong>
                            <?php endif; ?>
                            ...
                            <td><a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="btn btn-info btn-sm">Chi
                                    tiết</a></td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn1\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>