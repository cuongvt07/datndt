                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('product_variants.edit', $variant->id)); ?>" class="btn btn-warning btn-sm">Sửa</a>
                                        <form action="<?php echo e(route('product_variants.destroy', $variant->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH E:\laragon\www\datn1\resources\views/admin/product_variants/index.blade.php ENDPATH**/ ?>