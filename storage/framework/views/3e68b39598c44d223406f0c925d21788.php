...
<script>
   document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteVideoCheckbox.addEventListener('change', function () {
            if (this.checked) {
                videoInput.value = ''; // Xóa giá trị input khi chọn "Xóa video"
                videoInput.disabled = true; // Vô hiệu hóa input
            } else {
                videoInput.disabled = false; // Kích hoạt lại input khi bỏ chọn
            }
        });
});
