        ...
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <video class="hero-slider-item" autoplay muted loop
                    ...
                    <source src="<?php echo e(asset('asset-user/img/banner/HOME_Q6_Main-KV_1440x640_pc.web.webm')); ?>"
                        type="video/webm">
                </video>
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img"
                    data-bg="<?php echo e(asset('asset-user/img/slider/pexels-photo-4526478.webp')); ?>">
                </div>
                <div class="hero-content">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img"
                    data-bg="<?php echo e(asset('asset-user/img/slider/pexels-photo-4032364.webp')); ?>">
                </div>
                <div class="hero-content">
...
<?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/user/index.blade.php ENDPATH**/ ?>