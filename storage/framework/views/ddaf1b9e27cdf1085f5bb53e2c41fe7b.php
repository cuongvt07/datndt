                                ...
                                <div class="recent-post-item">
                                    <figure class="product-thumb1">
                                        <a href="<?php echo e(route('user.posts.show', $recentPost->id)); ?>">
                                            ...
                                            <img src="<?php echo e(asset('storage/' . $recentPost->image)); ?>" alt="Post Image" width="80px" height="80px">
                                            <?php else: ?>
                                    ...
                                    <div class="recent-post-description">
                                        <div class="product-name">
                                            <h6><a href="<?php echo e(route('user.posts.show', $recentPost->id)); ?>"><?php echo e($recentPost->title); ?></a></h6>
                        ...
                        <div class="blog-post-item" style="display: flex; margin-right: 50px; margin-bottom: 50px;">
                            <div class="al">
                                    ...
                                    <a href="<?php echo e(route('user.posts.show', $recentPost->id)); ?>">
                                        ...
                                        <div class="video-container">
                                            <iframe
                                                ...
                                                width="350px" height="250px"></iframe>
                                        </div>
                                        <?php elseif($recentPost->image): ?>
                                        <!-- Nếu không có video, hiển thị ảnh -->
                                ...
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <p><?php echo e($recentPost->created_at->format('F d, Y')); ?> | <a href="#">Polytech</a>
                                        </p>
                                    </div>
                                    <h4 class="blog-title">
                                        <a href="<?php echo e(route('user.posts.show', $recentPost->id)); ?>">
...
</style><?php /**PATH D:\laragon\www\datn1\resources\views/user/post/index.blade.php ENDPATH**/ ?>