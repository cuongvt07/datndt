...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="container mt-4">
            ...
            <form method="GET" action="<?php echo e(route('product_image.index')); ?>" class="mb-4" style="width:50%; margin-left: 400px;">
...
<?php /**PATH D:\ProjectDT\datn\datn\resources\views/admin/product_image/index.blade.php ENDPATH**/ ?>