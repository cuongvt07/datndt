                        ...
                        <div class="main-menu">
                            ...
                            <nav class="desktop-menu">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('shop')); ?>">Cửa hàng</a>
                                    </li>
                            ...
                            <ul class="nav justify-content-end">
                                ...
                                <li>
                                    <a href="<?php echo e(route('wishlist.index')); ?>">
                                        ...
                                        <span class="notification"><?php echo e(session('wishlistItemCount', 0)); ?></span>
                                    </a>
                                </li>
                                <li>
...
<?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/layouts/user/menu.blade.php ENDPATH**/ ?>