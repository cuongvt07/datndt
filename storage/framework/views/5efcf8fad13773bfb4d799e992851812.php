    ...
    <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="white">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo">
                <img src="<?php echo e(asset('fav/23.png')); ?>" width="200px" height="200px" alt="navbar brand" class="navbar-brand"
                    height="20" />
            </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="<?php echo e(route('product_variants.index')); ?>">
                                    <span class="sub-item">Sản phẩm | Ram</span>
                                </a>
                            </li>
...
<?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/layouts/admin/sitebar.blade.php ENDPATH**/ ?>