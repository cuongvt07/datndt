    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="container mt-4">
                ...
                <form action="<?php echo e(route('product_variants.index')); ?>" method="GET" class="mb-4"
                    style="width:50%; margin-left: 400px;">
                    <div class="d-flex">
                        <input type="text" name="search" class="form-control"
                            placeholder="Tìm kiếm sản phẩm hoặc biến thể..." value="<?php echo e(request()->get('search')); ?>">
                        <button type="submit" class="btn btn-primary ms-2">Tìm kiếm</button>
                    </div>
                </form>

                <a href="<?php echo e(route('product_variants.create')); ?>" class="btn btn-primary mb-3">Thêm mới liên kết</a>

                <!-- Hiển thị danh sách sản phẩm -->
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <p class="mb-0"><?php echo e($product->name_sp); ?></p>
                        ...
                        <div id="collapse-<?php echo e($product->id); ?>" class="collapse">
                            <div class="card-body">
                                <?php if($product->productVariants->isNotEmpty()): ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $product->productVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($variant->variant->ram_smartphone); ?></td>
                                                    <td>
                                                        <a href="<?php echo e(route('product_variants.edit', $variant->id)); ?>"
                                                            class="btn btn-warning btn-sm">Sửa</a>
                                                        <form
                                                            action="<?php echo e(route('product_variants.destroy', $variant->id)); ?>"
...
<?php /**PATH D:\ProjectDT\datn\datn\resources\views/admin/product_variants/index.blade.php ENDPATH**/ ?>