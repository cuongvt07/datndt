                    ...
                    <div class="shop-product-wrapper">
                        ...
                        <div class="paginatoin-area text-center">
                            <ul class="pagination-box">
                                ...
                                <li class="disabled"><a href="javascript:void(0);"><i class="pe-7s-angle-left"></i></a></li>
                                <?php else: ?>
                                <li><a class="previous" href="<?php echo e($products->previousPageUrl()); ?>"><i class="pe-7s-angle-left"></i></a></li>
                                <?php endif; ?>
                                ...
                                <li><a class="next" href="<?php echo e($products->nextPageUrl()); ?>"><i class="pe-7s-angle-right"></i></a></li>
                                <?php else: ?>
                                <li class="disabled"><a href="javascript:void(0);"><i class="pe-7s-angle-right"></i></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <!-- End Phân trang -->
...
<?php echo $__env->make('layouts.user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn1\resources\views/user/shop.blade.php ENDPATH**/ ?>