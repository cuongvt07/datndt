        ...
        <form action="<?php echo e(route('checkout.handle')); ?>" method="POST" id="checkout-form">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="payment_method" id="cash" value="cash"
                    required>
                <label class="form-check-label" for="cash">Thanh toán tiền mặt</label>                                   <img src="<?php echo e(asset('fav/images (1).png')); ?>" width="2%" alt="">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="payment_method" id="online_payment" value="online"
                    required>
                <label class="form-check-label" for="online_payment">Thanh toán trực tuyến (VNPay</label> <img src="<?php echo e(asset('fav/images.png')); ?>" width="2%" alt="">)
            </div>
...
<?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/checkout/index.blade.php ENDPATH**/ ?>