...
<iframe id="chat-history-iframe" src="<?php echo e(route('admin.chat.refresh', ['id' => $id, 'type' => $type])); ?>" frameborder="0"
    style="width: 100%; height: 500px;"></iframe>


<form class="chat-footer" id="chat-form" action="<?php echo e(route('admin.chat.send', ['id' => $id, 'type' => $type])); ?>"
...
<?php /**PATH D:\ProjectDT\datn\datn\resources\views/admin/chat/messages.blade.php ENDPATH**/ ?>