            ...
            <tbody>
                <?php $__currentLoopData = $orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(number_format(($item->product->price + ($item->variant->price ?? 0) + ($item->color->price ?? 0)) * $item->quantity, 0, ',', '.')); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($discountAmount == 0): ?>
                            <strong style="font-size: 16px"><?php echo e(number_format($totalAfterDiscount + $shippingFee, 0, ',', '.')); ?>

                                ₫</strong>
                        <?php else: ?>
                            <strong
                                style="font-size: 16px; color: red;"><?php echo e(number_format($totalAfterDiscount + $shippingFee, 0, ',', '.')); ?>

                                ₫</strong>
                            <br>
                            <span
                                style="text-decoration: line-through; font-size: 12px;"><?php echo e(number_format($totalPrice, 0, ',', '.')); ?>

                                ₫</span>
                            <br>
                            <span style="font-size: 12px; color: green;">Bạn tiết kiệm:
                                <?php echo e(number_format($totalPrice - $totalAfterDiscount, 0, ',', '.')); ?> ₫</span>
                        <?php endif; ?>
                    </td>
                    </td>
                </tr>
...
<?php /**PATH D:\ProjectDT\datn\datn\resources\views/checkout/success.blade.php ENDPATH**/ ?>