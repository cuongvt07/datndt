    ...
    <form action="<?php echo e(route('admin.orders.store')); ?>" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-4">
                ...
                <select id="tinh" name="province" class="form-select" required>
            ...
            <div class="col-md-4">
                ...
                <select id="quan" name="district" class="form-select" required>
            ...
            <div class="col-md-4">
                ...
                <select id="phuong" name="ward" class="form-select" required>
        ...
        <div class="form-group">
            ...
            <select name="variant_id" id="variant_id" class="form-control">
                ...
                <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($variant->id); ?>" data-price="<?php echo e($variant->extra_price); ?>"><?php echo e($variant->ram_smartphone); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="shipping_fee" id="shipping_fee" class="form-control" required>
        </div>
...
<script>
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(product => {
                        options += `<option value="${product.id}" data-price="${product.price}">${product.name_sp}</option>`;
                    });
        ...
        $('#quantity, #product_id, #variant_id, #color_id').on('change', function () {
            ...
            let totalPrice = (productPrice + variantPrice + colorPrice) * quantity + parseInt(shippingFee);
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\datn1\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>