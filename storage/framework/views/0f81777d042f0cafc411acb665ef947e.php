                    ...
                    <tr>
                                                    ...
                                                    <div class="product-details card shadow-sm mb-4"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="product-info-collapse">
                                                                ...
                                                                <div class="product-info">
                                                                    <strong>Giá:</strong>
                                                                    <span><?php echo e(number_format($order->total_price, 0, ',', '.')); ?>
                        ...
                        <td>
                            <?php if($order->discount_amount == 0): ?>
                                <strong
                                    style="font-size: 16px"><?php echo e(number_format($order->total_after_discount + $order->shipping_fee, 0, ',', '.')); ?>

                                    ₫</strong>
                            <?php else: ?>
                                <strong
                                    style="font-size: 16px; color: red;"><?php echo e(number_format($order->total_after_discount + $order->shipping_fee, 0, ',', '.')); ?>
