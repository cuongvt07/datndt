<div class="main-header">
            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                        aria-expanded="false">
                        <div class="avatar-sm">
                            <img src="<?php echo e(asset('asset-admin/img/profile.jpg')); ?>" alt="..."
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4><?php echo e(Auth::user()->name_user); ?></h4>
                            ...
                            <li>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo e(route('account')); ?>">Thiết lập tài khoản</a>
                                <a class="dropdown-item" href="<?php echo e(route('user.index')); ?>">Đăng nhập người dùng</a>
                                <div class="dropdown-divider"></div>
  ...
  <?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/layouts/admin/header.blade.php ENDPATH**/ ?>