                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    ...
                                    <p class="pro-desc">Dung lượng pin: <?php echo e($product->battery->capacity); ?></p>
                                            ...
                                            <?php $__currentLoopData = $productVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productVariant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="me-2">
                                                    <button class="btn2 btn-outline-primary variant-button"
                                                        data-price="<?php echo e($productVariant->variant->price); ?>"
                                                        data-id="<?php echo e($productVariant->variant->id); ?>"
                                                        data-quantity="<?php echo e($productVariant->quantity); ?>">
                                                        <?php echo e($productVariant->variant->ram_smartphone); ?>
                                    ...
                                    <div class="useful-links">
                                        ...
                                        <a href="javascript:void(0);" data-bs-toggle="tooltip" title="Wishlist"
                                            class="add-to-wishlist" data-product-id="<?php echo e($product->id); ?>">
...
<?php /**PATH D:\LARAGON-PHP2\laragon\www\datn\resources\views/user/shop-single.blade.php ENDPATH**/ ?>