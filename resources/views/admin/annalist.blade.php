        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <div class="mt-4">
                        <form method="GET" action="{{ route('admin.annalist') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            const supplierLabels = {!! json_encode(array_keys($supplierData)) !!}; // Tên nhà cung cấp
                                            const supplierData = {!! json_encode(array_values($supplierData)) !!}; // Số lượng sản phẩm
                                            ...
                                            const categoryLabels = {!! json_encode(array_keys($categoryData)) !!}; // Tên loại sản phẩm
                                            const categoryData = {!! json_encode(array_values($categoryData)) !!}; // Số lượng sản phẩm
                                        ...
                                        <div class="mt-4 ms-4">
                                            ...
                                            @else
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($unpopularProducts as $product)
                                                            <tr>
                                                                <td>{{ $product->id }}</td>
                                                                <td>{{ $product->name_sp }}</td>
                                                            </tr>
                    ...
                    <div class="col-md-6">
                        <div class="card card-round1">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    // Dữ liệu từ backend
                                    const labels = {!! json_encode($allDates) !!}; // Danh sách đủ 15 ngày
                                    const data = {!! json_encode($data) !!}; // Tổng stock sản phẩm mỗi ngày
                        ...
                        <div class="card card-round1">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    const userLabels = {!! json_encode($allDates) !!}; // Danh sách ngày từ start_date đến end_date
                                    const userCounts = {!! json_encode($userCounts) !!}; // Số lượng khách hàng mới tương ứng
