                    ...
                    <div class="tab-pane fade active show" id="account-general">
                        <form method="POST" action="{{ route('account.update') }}" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ Auth::user()->name_user }}"
                                    name="name_user">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-sqr" style="margin-bottom: 10px;">Lưu thay
                                đổi</button>
                        </form>
                    </div>
