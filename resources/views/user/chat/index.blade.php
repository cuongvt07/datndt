...
<div id="chat-history" class="chat-body">
    @include('partials.chat-messages', ['messages' => $messages, 'userName' => $userName])
</div>
<!-- Form gửi tin nhắn -->

<form action="{{ route('user.chat.send') }}" method="POST" enctype="multipart/form-data" class="chat-footer">
    @csrf
    <!-- Nút chọn ảnh -->
