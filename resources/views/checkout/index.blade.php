...
<main>
                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="{{ route('cart.show') }}">Giỏ
                                        hàng</a></li>
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('checkout.handle') }}" method="POST" id="checkout-form">
            @csrf
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="payment_method" id="cash" value="cash"
                    required>
                <label class="form-check-label" for="cash">Thanh toán tiền mặt</label>                                   <img src="{{ asset('fav/images (1).png') }}" width="2%" alt="">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="payment_method" id="online_payment" value="online"
                    required>
                <label class="form-check-label" for="online_payment">Thanh toán trực tuyến (VNPay</label> <img src="{{ asset('fav/images.png') }}" width="2%" alt="">)
            </div>
                    ...
                    <tbody>
                        ...
                        @if (session('discount_percentage') > 0)
                            <tr>
                                ...
                                <td>{{ session('discount_percentage') }}%</td>
                            </tr>
                        @endif
                        ...
                        @if (session('discount_amount') > 0)
                            <tr>
                                ...
                                <td>{{ number_format(session('discount_amount'), 0, ',', '.') }} ₫</td>
                            </tr>
                        @endif
                        <tr>
                            ...
                            <td>
                                @if ($totalAmount == $totalAfterDiscount)
                                    <strong id="grand_total" style="font-size: 16px">
                                        {{ number_format($totalAfterDiscount + $shippingFee, 0, ',', '.') }} ₫
                                    </strong>
                                @else
                                    ...
                                    <span style="font-size: 12px; color: green;">Bạn tiết kiệm:
                                        {{ number_format($totalAmount - $totalAfterDiscount, 0, ',', '.') }} ₫</span>
                                @endif
                            </td>
                        </tr>
                    </tbody>
...
<script>
    function calculateShippingFee() {
        ...
        // Tính lại tổng tiền
        let totalAfterDiscount = parseFloat('{{ $totalAfterDiscount }}'); // Giá trị từ backend
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        ...
                        <div class="widget-body">
                            <p>StorePhone là địa chỉ uy tín chuyên cung cấp các sản phẩm thời trang nam chất lượng cao,
