...
<div id="chat-widget">
    <!-- Icon chat -->
    <div id="chat-icon">
        <img src="{{ asset('asset-user/img/chat/Facebook_messenger_pink_app_icon-removebg-preview.png') }}"
            alt="Chat Icon">
    ...
    <div id="chat-popup">
        <div id="chat-header">
            <span>Hỗ trợ trực tuyến <img class="iconcd" src="{{ asset('asset-user/img/chat/Animation - 1732688263923.gif') }}" alt=""></span>
            <button id="close-chat"><img class="iconcd" src="{{ asset('asset-user/img/chat/Animation - 1732689196344.gif') }}" alt=""></button>
        </div>
        <iframe id="chat-iframe" src="{{ route('user.chat') }}" frameborder="0"></iframe>
    </div>
</div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        ...
                        <div class="widget-body">
                            <p>StorePhone là địa chỉ uy tín chuyên cung cấp các sản phẩm công nghệ chất lượng cao,
...
<!-- Modernizer JS -->
<script src="{{ asset('asset-user/js/vendor/modernizr-3.6.0.min.js') }}"></script>

<!-- jQuery JS -->
<script src="{{ asset('asset-user/js/vendor/jquery-3.6.0.min.js') }}"></script>

<!-- Bootstrap JS -->
<script src="{{ asset('asset-user/js/vendor/bootstrap.bundle.min.js') }}"></script>

<!-- slick Slider JS -->
<script src="{{ asset('asset-user/js/plugins/slick.min.js') }}"></script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function markMessagesAsRead() {
            $.ajax({
                url: '{{ route('chat.markRead') }}', // Gọi đúng route đã khai báo
                method: 'POST',
                data: {
        ...
        function fetchUnreadMessages(callback = null) {
            $.ajax({
                url: '{{ route('user.chat') }}?format=json', // API lấy tin nhắn
                method: 'GET',
                success: function(response) {
