                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong id="grand_total" style="font-size: 16px"><?php echo e(number_format($totalAfterDiscount + $shippingFee, 0, ',', '.')); ?> ₫</strong> <br>
...
<script>
    ...
    const nearHoChiMinh = ['79', '77', '74', '75', '80', '82', '83', '84', '87', '70', '72', '96', '92', '93', '91', '94', '86'];
    ...
    document.getElementById('grand_total').innerHTML = `
        ...
        <br>
        <s style="font-size: 10px;">$<?php echo e($totalAmount); ?> ₫</s>
    `;
}
...
<?php /**PATH C:\laragon\www\datn\resources\views/checkout/index.blade.php ENDPATH**/ ?>