            ...
            <tbody>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <div id="edit-address-form-<?php echo e($order->id); ?>" style="display: none;">
                            <form action="<?php echo e(route('orders.updateAddress', ['order' => $order->id])); ?>" method="POST">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="detail_address"
                                            value="<?php echo e($order->detail_address); ?>" placeholder="Địa chỉ chi tiết"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <select id="tinh-<?php echo e($order->id); ?>" name="province" class="form-select"
                                            title="Chọn Tỉnh Thành" required>
                                            <option value="0">Tỉnh Thành</option>
                                            <!-- Đổ dữ liệu tỉnh thành từ API -->
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <select id="quan-<?php echo e($order->id); ?>" name="district" class="form-select"
                                    ...
                                    <div class="col-md-4">
                                        <select id="phuong-<?php echo e($order->id); ?>" name="ward" class="form-select"
...
<?php /**PATH E:\laragon\www\datn\resources\views/orders/index.blade.php ENDPATH**/ ?>