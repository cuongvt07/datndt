        ...
        <ul class="list-group list-group-flush">
            <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="list-group-item d-flex align-items-center">
                    ...
                    <span class="text-primary font-weight-bold large-text"> <?php echo e(number_format($totalPrice, 0, ',', '.')); ?> VND</span>
                </li>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>