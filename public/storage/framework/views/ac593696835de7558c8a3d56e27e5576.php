                        ...
                        <div class="blog-sidebar">
                            ...
                            <ul class="blog-archive">
                                <?php $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(route('user.posts.archive', ['year' => $archive->year, 'month' => $archive->month])); ?>">
                                            <?php echo e($archive->month_name); ?> (<?php echo e($archive->count); ?>)
                                        </a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php /**PATH C:\laragon\www\datn\resources\views/user/post/show.blade.php ENDPATH**/ ?>