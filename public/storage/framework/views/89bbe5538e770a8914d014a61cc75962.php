            ...
            <div class="row1 row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-center">
                            ...
                            <h2 class="banner-text2" style="color: white">TAI NGHE<span style="color: #0cc0df;">GAMING</span></h2>
                            <a href="shop.html" class="btn1 btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-center">
                            <!-- <h5 class="banner-text1">NEW ARRIVALLS</h5> -->
                            <h2 class="banner-text2" style="color: white">SAMSUNG<span style="color: #0cc0df;">THỜI THƯỢNG</span></h2>
                            <a href="shop.html" class="btn1 btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        ...
                        <div class="banner-content text-center">
                            <!-- <h5 class="banner-text1">NEW ARRIVALLS</h5> -->
                            <h2 class="banner-text2" style="color: white">IPHONE<span style="color: #0cc0df;">TRẺ TRUNG</span></h2>
                            <a href="shop.html" class="btn1 btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="<?php echo e(asset('asset-user/img/banner/banner4.png')); ?>" alt="product banner">
                        </a>
                        <div class="banner-content text-center">
                            <!-- <h5 class="banner-text1">NEW ARRIVALLS</h5> -->
                            <h2 class="banner-text2" style="color: white">PHỤ KIỆN<span style="color: #0cc0df;">ĐA DẠNG</span></h2>
                            <a href="shop.html" class="btn1 btn-text">Shop Now</a>
                        </div>
                    </figure>
                </div>
                    ...
                    <div class="product-container">
                        ...
                        <div class="product-tab-menu">
                            <ul class="nav justify-content-center">
                                <li><a href="#tab1" class="active" data-bs-toggle="tab">Sự giải trí</a></li>
                                <li><a href="#tab2" data-bs-toggle="tab">Kho</a></li>
                                <li><a href="#tab3" data-bs-toggle="tab">Nằm</a></li>
                                <li><a href="#tab4" data-bs-toggle="tab">Bảng</a></li>
                            </ul>
                        </div>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-6.jpg')); ?>"
                                                    alt="product">
                                                <img class="sec-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-13.jpg')); ?>"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                ...
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-11.jpg')); ?>"
                                                    alt="product">
                                                <img class="sec-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-8.jpg')); ?>"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                ...
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-16.jpg')); ?>"
                                                    alt="product">
                                                <img class="sec-img"
                                                    src="<?php echo e(asset('asset-user/img/product/product-3.jpg')); ?>"
                                                    alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                ...
                <div class="col-12">
                    <div class="product-carousel-4_2 slick-row-10 slick-arrow-style">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption text-center">
                                <div class="product-identity">
                                    <p class="manufacturer-name"><a href="product-details.html"><?php echo e($product->category->name); ?></a></p>
                                </div>
                                <ul class="color-categories">
                                    <li>
                                        <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="price-box">
                                    <span class="price-regular"><?php echo e(number_format($product->price, 0, ',', '.')); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="blog-post-item">
                    <figure class="blog-thumb">
                        <a href="blog-details.html">
                            <img src="<?php echo e(asset('asset-user/img/blog/2.jpg')); ?>" alt="blog image">
                        </a>
                    </figure>
                    <div class="blog-content">
                        ...
                        <h5 class="font-min blog-title">
                            <a href="blog-details.html">Bùng Nổ Với Sự Ra Mắt Chính Thức Của IPHONE 16</a>
                        </h5>
                    </div>
                ...
                <div class="blog-post-item">
                    <figure class="blog-thumb">
                        <a href="blog-details.html">
                            <img src="<?php echo e(asset('asset-user/img/blog/1.jpg')); ?>" alt="blog image">
                        </a>
                    </figure>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <h5 class="font-min blog-title">
                            <a href="blog-details.html">mẫu điện thoại màn hình gập đáng mua nhất hiện nay</a>
                        </h5>
                    </div>
                ...
                <div class="blog-post-item">
                    <figure class="blog-thumb">
                        <a href="blog-details.html">
                            <img src="<?php echo e(asset('asset-user/img/blog/3.jpg')); ?>" alt="blog image">
                        </a>
                    </figure>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <h5 class="font-min blog-title">
                            <a href="blog-details.html">Bảng Xếp Hạng Top 50 Con Chip Mạnh Nhất 2024</a>
                        </h5>
                    </div>
...
<?php if(session('status')): ?>
    <script>
        $(document).ready(function() {
            ...
            toastr.success('<?php echo e(session('status')); ?>'); // Hiển thị thông báo thành công
        });
    </script>
<?php endif; ?>
...
<script>
    var imageUrl = undefined; // Biến này nên được thiết lập thành một URL hợp lệ

    $('.bg-img').each(function() {
        var bg = $(this).data('bg'); // Đảm bảo 'data-bg' có giá trị hợp lệ
        if (bg) {
            $(this).css('background-image', 'url(' + bg + ')');
        } else {
            console.error('URL không hợp lệ cho phần tử: ', $(this)); // Thêm thông báo lỗi để kiểm tra
        }
    });
</script>
...
<?php echo $__env->make('layouts.user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn\resources\views/user/index.blade.php ENDPATH**/ ?>