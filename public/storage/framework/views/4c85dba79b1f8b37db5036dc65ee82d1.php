<?php $__env->startSection('content'); ?>
    <table class="table">
        <a href="<?php echo e(route('admin.discount_codes.create')); ?>" class="btn btn-primary btn-block">Tạo mã giảm
            giá</a>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn\resources\views/admin/discount_codes/index.blade.php ENDPATH**/ ?>